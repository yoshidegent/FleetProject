INSERT INTO `fleet`.`user` (`DTYPE`, `id`, `version`, `email`, `password`, `dateOfBirth`, `firstName`, `function`, `functionalLevel`, `hireDate`, `lastName`) VALUES ('Employee', '1', '1', 'yoshi.degent@realdolmen.com', '$2a$04$4.QXaVbhnR7MR58foRJxROca5yY1qLvN2KkZFdo980vpCep3P5/Lm', NOW(), 'Yoshi', 'Developer', '2', NOW(), 'Degent');
