INSERT INTO `fleet`.`user` (`DTYPE`, `id`, `version`, `email`, `password`, `dateOfBirth`, `firstName`, `function`, `functionalLevel`, `hireDate`, `lastName`, `isActive`) VALUES ('Employee', '1', '1', 'yoshi.degent@realdolmen.com', '$2a$04$4.QXaVbhnR7MR58foRJxROca5yY1qLvN2KkZFdo980vpCep3P5/Lm', NOW(), 'Yoshi', 'Developer', '5', NOW(), 'Degent', 1);
INSERT INTO `fleet`.`user` (`DTYPE`, `id`, `version`, `email`, `password`, `dateOfBirth`, `firstName`, `function`, `functionalLevel`, `hireDate`, `lastName`, `isActive`) VALUES ('Employee', '2', '1', 'dean.wyns@realdolmen.com', '$2a$04$4.QXaVbhnR7MR58foRJxROca5yY1qLvN2KkZFdo980vpCep3P5/Lm', NOW(), 'Dean', 'Developer', '2', NOW(), 'Wyns', 1);
